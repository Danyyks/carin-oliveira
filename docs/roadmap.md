...
| 4 | **Serviços & disponibilidade** | Login do painel + CRUD de serviços/combos/promoções + definição de dias/horários; site lê serviços reais | ✅ feito |
...
| 8 | **Mapa + polish + go-live** | Mini-mapa ✅; revisão geral (design/segurança/testes) ✅; foto real ✅. Falta: trocar WhatsApp de teste pelo da Carin + (opcional) domínio | ⏳ quase |

> Revisão completa (14/09/2026) por subagentes de design, qualidade e testes — ver
> [`melhorias-pendentes.md`](melhorias-pendentes.md) para o que foi aplicado e os próximos passos.
